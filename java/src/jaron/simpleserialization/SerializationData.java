...
public abstract class SerializationData {
  ...
  public void addListener(SerializationDataEventListener listener) {
    listeners.add(SerializationDataEventListener.class, listener);
  }
  
  protected synchronized void notifyListeners() {
    for (SerializationDataEventListener listener : listeners.getListeners(SerializationDataEventListener.class)) {
      listener.dataUpdate(this);
    }
  }
